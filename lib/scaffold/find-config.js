...
/**
 * Will return the path and bitcore-node-finite configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'bitcore-node-finite.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'bitcore-node-finite.json'))
  };
}
